            ...
            <div className="space-y-2">
              ...
              {agents.map((agent) => (
                <Link
                  ...
                  className="flex items-center justify-between rounded-[var(--radius-xl)] border border-[var(--color-line)] bg-surface px-5 py-4 transition-colors hover:border-[var(--color-line-accent)]"
                >
                  <div>
